...
cat("Main mix:\n", ((NEB_Next_reagent)*(n)), "µl of NEBNext Strand Specificity Reagent\n",
    (NEB_Next_Enzyme*n), "µl of NEBNext 1st Strand Synthesis Enzyme Mix\n",
    "ON ICE, add 10 µl to all mRNA samples (which should all be 10µl at this point too)")
```
